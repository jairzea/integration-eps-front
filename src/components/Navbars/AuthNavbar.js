...
import logoLandscape from "assets/img/logoLandscape.png";
...
export default function AuthNavbar(props) {
  ...
  let bgButton = useColorModeValue(
    "linear-gradient(81.62deg, #e53e3e 2.25%, #45826547 79.87%)",
    "gray.800"
  );
  ...
  var brand = (
    <Link
      ...
      color={mainText}
    >
      <img src={logoLandscape} width={70}/>
  ...
  return (
    ...
    >
      <Flex w="100%" justifyContent={{ sm: "start", lg: "space-between" }}>
        ...
        {linksAuth}
        <Link href="https://curaduria2cartagena.com/">
          <Button
            bg={bgButton}
            color={colorButton}
            fontSize="xs"
